...
/*   Updated: 2023/01/20 20:50:13 by mjalloul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void rays(t_cub3d *var)
{
  ...
  while (ray_angle <  VIEW / 2)
  {
    x_wall = 0;
    y_wall = 0;
    intersection(var,var->alpha+  ray_angle,&var->x_wall,&var->y_wall);
    rindring3d(var,var->x_wall,var->y_wall,ray_3d,ray_angle);
