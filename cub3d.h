...
/*   Updated: 2023/01/20 21:11:28 by mjalloul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 	rindring3d(t_cub3d *var, double x, double y,int ray_3d,double angle);
void	intersection(t_cub3d *var,double angle,double *x_wall,double *y_wall);
